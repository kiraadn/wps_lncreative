(function ($) {
    ...
    elementorFrontend.hooks.addAction(
      ...
      function ($scope, $) {
        $scope.find(".cozy-addons-brands-logo").each(function () {
          ...
          var brandsSlidersPerView =
            brandsSlideCarousel.attr("data-slidePerView");
          var carouselGridGap = parseInt(
    ...
    elementorFrontend.hooks.addAction(
      ...
      function ($scope, $) {
        $scope.find(".cozy-addons-teams").each(function () {
          ...
          var carouselGridGap = parseInt(
            teamSlideCarousel.attr("data-carouselColumnGap")
          );
          if (carouselGridGap >= 1) {
            var currentGridGap = carouselGridGap;
          } else {
    ...
    elementorFrontend.hooks.addAction(
      ...
      function ($scope, $) {
        ...
        $scope.find(".cozy-addons-post-slider").each(function () {
          ...
          var postBlogSlidersPerView =
            postSlidersCarousel.attr("data-slidePerView");
          var carouselGridGap = parseInt(
    ...
    elementorFrontend.hooks.addAction(
      ...
      function ($scope, $) {
        $scope.find(".cozy-addons-advanced-magazine-block").each(function () {
          ...
          var carouselGridGap = parseInt(
            advMagCarousel.attr("data-carouselColumnGap")
          );
          if (carouselGridGap >= 1) {
            var currentGridGap = carouselGridGap;
          } else {
    ...
    elementorFrontend.hooks.addAction(
      ...
      function ($scope, $) {
        $scope.find(".cozy-addons-testimonial").each(function () {
          ...
          var testimonialSlidePerView =
            testimonialCarousel.attr("data-slidePerView");
          var carouselGridGap = parseInt(
        ...
        var swiperTestimonialCarouselSlide = new Swiper(
          ".cozy-testimonial-slide",
          {
            spaceBetween: 40,
            slidesPerView: 1,
            loop: true,
        ...
        var swiperTestimonialCentered = new Swiper(
          ".cozy-testimonial-centered",
          {
            spaceBetween: 30,
            slidesPerView: 1,
            centeredSlides: true,
    ...
    elementorFrontend.hooks.addAction(
      ...
      function ($scope, $) {
        $scope.find(".elementor-widget-container").each(function () {
          ...
          var carouselGridGap = parseInt(
            wooCatCarousel.attr("data-carouselColumnGap")
          );
          if (carouselGridGap >= 1) {
            var currentGridGap = carouselGridGap;
          } else {
    ...
    elementorFrontend.hooks.addAction(
      ...
      function ($scope, $) {
        $scope.find(".cozy-addons-promotions").each(function () {
          ...
          var carouselGridGap = parseInt(
            offerCarousel.attr("data-carouselColumnGap")
          );
          if (carouselGridGap >= 1) {
            var currentGridGap = carouselGridGap;
          } else {
    ...
    elementorFrontend.hooks.addAction(
      ...
      function ($scope, $) {
        $scope.find(".cozy-addons-blog").each(function () {
          ...
          var carouselGridGap = parseInt(
            blogPostCarousel.attr("data-carouselColumnGap")
          );
          if (carouselGridGap >= 1) {
            var currentGridGap = carouselGridGap;
          } else {
    ...
    elementorFrontend.hooks.addAction(
      ...
      function ($scope, $) {
        $scope.find(".cozy-addons-products").each(function () {
          ...
          var carouselGridGap = parseInt(
            productCarousel.attr("data-carouselColumnGap")
          );
          if (carouselGridGap >= 1) {
            var currentGridGap = carouselGridGap;
          } else {
    ...
    elementorFrontend.hooks.addAction(
      ...
      function ($scope, $) {
        ...
        $scope.find(".cozy-addons-products-slider").each(function () {
          const productSliderCarousel = $(this).find(
            "#cozyProductSlideCarousel"
          );
          var productSlideSliderPerView =
            productSliderCarousel.attr("data-slidePerView");
          var carouselGridGap = parseInt(
    ...
    elementorFrontend.hooks.addAction(
      ...
      function ($scope, $) {
        $scope.find(".cozy-addons-portfolios").each(function () {
          ...
          var portfolioSlidePerView =
            portfolioCarousel.attr("data-slidePerView");
          var carouselGridGap = parseInt(
            portfolioCarousel.attr("data-carouselColumnGap")
          );
          if (carouselGridGap >= 1) {
            var currentGridGap = carouselGridGap;
          } else {
    ...
    elementorFrontend.hooks.addAction(
      ...
      function ($scope, $) {
        $scope.find(".cozy-addons-properties-list").each(function () {
          ...
          var carouselGridGap = parseInt(
            propertyCarouel.attr("data-carouselColumnGap")
          );
          if (carouselGridGap >= 1) {
            var currentGridGap = carouselGridGap;
          } else {
    ...
    elementorFrontend.hooks.addAction(
      ...
      function ($scope, $) {
        $scope.find(".cozy-addons-travel-destination-list").each(function () {
          ...
          var carouselGridGap = parseInt(
            travelCarouel.attr("data-carouselColumnGap")
          );
          if (carouselGridGap >= 1) {
            var currentGridGap = carouselGridGap;
          } else {
    ...
    elementorFrontend.hooks.addAction(
      ...
      function ($scope, $) {
        $scope.find(".cozy-addons-course-list").each(function () {
          ...
          var carouselGridGap = parseInt(
            courseCarouel.attr("data-carouselColumnGap")
          );
          if (carouselGridGap >= 1) {
            var currentGridGap = carouselGridGap;
          } else {
  ...
  $(window).on("elementor/frontend/init", function () {
    elementorFrontend.hooks.addAction(
      ...
      function ($scope, $) {
        var selectedSubMenuIcon = $(".cozy-addons-nav-menu").attr(
          "data-dropDownIcon"
        );
        ...
        $scope
          ...
          .click(function (event) {
            ...
            var nav_container = toggle_button.next(
              ".cozy-navigation-container"
            );
            $scope
              .find(".cozy-responsive-navigation .toggle-button")
              .not(toggle_button)
        ...
        $scope.find(".close-button").click(function (event) {
          ...
          toggleButton
            .next(".cozy-navigation-container")
            .removeClass("active")
            .hide();
        });
        ...
        $scope.find(".cozy-addons-nav-menu.event-click").each(function () {
          ...
          menu.find("ul li a .dropdown-icon").click(function (e) {
            ...
            menu
              .find(".cozy-addons-nav-menu.event-click")
              .not(submenu)
              .removeClass("visible");
        ...
        $scope
          ...
          .each(function () {
            ...
            menu.find("ul li a .dropdown-icon").click(function (e) {
              ...
              var submenu = $(this).closest("a").siblings("ul");
              menu
                .find(".cozy-responsive-navigation")
                .not(submenu)
                .removeClass("visible")
      ...
      function ($scope, $) {
        if (!$scope.find(".cozy-addons-menu-cart a").attr("href")) {
          ...
          $scope.find(".cozy-addons-menu-cart a").click(function () {
            $scope
              .find(".cozy-sidebar-panel-wrapper")
        ...
        function removeCartItem() {
          ...
          var empty_cart_text = $(".cozy-menu-sidebar-panel").attr(
          ...
          $.post(ajax_url, data, function (response) {
            if (response.success) {
              ...
              if (response.data.cart_count == 0) {
                $(".cozy-menu-sidebar-panel").append(
                  response.data.empty_cart_html
                );
              }
            } else {
  ...
  $(window).on("elementor/frontend/init", function () {
    elementorFrontend.hooks.addAction(
      ...
      function ($scope, $) {
        ...
        $scope
          .find(".cozy-addons-menu-search .cozy-search-icon")
          .click(function () {
        ...
        $(window).click(function (event) {
          ...
          if (
            ...
            $(".cozy-addons-menu-search .cozy-search-icon.active").toggleClass(
              "active"
            );
          }
        });
    ...
    elementorFrontend.hooks.addAction(
      ...
      function ($scope, $) {
        ...
        if (toggleBtns.length > 0) {
          $(".cozy-addons-content-toggle button:first-child").addClass(
            "active"
          );
        }
      }
    ...
    elementorFrontend.hooks.addAction(
      ...
      function ($scope, $) {
        $scope.find(".cozy-addons-events").each(function () {
          ...
          var carouselGridGap = parseInt(
            eventCarousel.attr("data-carouselColumnGap")
          );
          if (carouselGridGap >= 1) {
            var currentGridGap = carouselGridGap;
          } else {
  ...
  $(window).on("elementor/frontend/init", function () {
    elementorFrontend.hooks.addAction(
      ...
      function ($scope, $) {
        ...
        if (
          $scope
            .find(".cozy-login-form .woocommerce-notices-wrapper")
            .children().length > 0
        ) {
          $scope.find(".cozy-login-form").addClass("display-form");
          $(".cozy-popup").addClass("popup-visible");
...
function openContent(evt, contentTitle) {
  var i;
  // Ensure you are always working with the button, even if a span inside it is clicked
  var button = evt.target.closest("button");
  button.classList.add("active");

  // Get all sibling elements of the button
  var buttonSiblings = button.parentNode.children;

  // Loop through siblings to remove the "active" class from buttons
  for (var i = 0; i < buttonSiblings.length; i++) {
    if (
      buttonSiblings[i] !== button &&
      buttonSiblings[i].classList.contains("cozy-toggle-button")
    ) {
      buttonSiblings[i].classList.remove("active");
    }
  }

  // 	Get the content siblings
  var contentSiblings = button.parentNode.parentNode.children;
  Array.from(contentSiblings).forEach((content) => {
    if (content.classList.contains("cozy-toggle-content")) {
      // Check if the content has an ID
      if (content.id === contentTitle) {
